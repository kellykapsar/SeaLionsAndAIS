...
ssl <- readRDS("../Data_Processed/Telemetry/UsedAndAvail_WeeklyKDE_20211014.rds")

# Standardize covariate values by subtracting from mean and dividing by standard deviation
ssl <- ssl %>% mutate_at(covar_names, ~(scale(.) %>% as.vector))
