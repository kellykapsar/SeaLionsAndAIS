...
saveRDS(ssl, "../Data_Processed/Telemetry/UsedAndAvail_Swhr_ALLCases_20220711.rds")
write.csv(ssl, "../Data_Processed/Telemetry/UsedAndAvail_Swhr_ALLCases_20220711.csv")

# Make it spatial again
ssl_sf <- st_as_sf(ssl, coords = c("easting", "northing"), crs=prj, remove=FALSE)

# Save output as spatial object
st_write(ssl_sf, "../Data_Processed/Telemetry/UsedAndAvail_Swhr_ALLCases_20220711.shp")
...
saveRDS(ssl_narrow_nocoords, "../Data_Processed/Telemetry/UsedAndAvail_Swhr_20220711.rds")
write.csv(ssl_narrow_nocoords, "../Data_Processed/Telemetry/UsedAndAvail_Swhr_20220711.csv")

# Make it spatial again
ssl_narrow <- st_as_sf(ssl_narrow, coords = c("easting", "northing"), crs=prj, remove=FALSE)

# Save output as spatial object
st_write(ssl_narrow, "../Data_Processed/Telemetry/UsedAndAvail_Swhr_20220711.shp")
