...
st_write(ssl_hr, "../Data_Processed/Telemetry/Homerange_KDE_season_20220610.shp")
...
all_pts <- avail_pts_new %>% st_as_sf(., coords=c("easting", "northing"), crs=prj, remove=FALSE) %>% rbind(., ssl_new)
