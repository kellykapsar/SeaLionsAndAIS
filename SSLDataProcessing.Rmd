...
sealis <- rename(sealis, deploy_id = deploy_id, error_rad = error.radius, error_major = error.semi.major.axis, 
...
ggplot() +
  ...
  geom_path(data=sealis, aes(x=easting, y=northing, color=deploy_id))
...
ggplot(timeline, aes(x=starttag, y= deploy_id)) +
