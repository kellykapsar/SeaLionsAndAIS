...
avail$sst <- extract_covar_var_time_custom(xy= cbind(avail$x, avail$y), t = avail$Date, covariates=sst)
avail$wind <- extract_covar_var_time_custom(xy= cbind(avail$x, avail$y), t = avail$Date, covariates=wind)
avail$ship <- extract_covar_var_time_custom(xy= cbind(avail$x, avail$y), t = avail$Date, covariates=ship)
avail$fish <- extract_covar_var_time_custom(xy= cbind(avail$x, avail$y), t = avail$Date, covariates=fish)
