...
for(i in 1:length(unique(idx))){
  ...
  seasonras1 <- sum(ras[,,,1:5])
  seasonras2 <- sum(ras[,,,6:nlayers(ras)])
...
writeRaster(wind_brick_season, "../Data_Processed/wind_brick_season.tif", options="INTERLEAVE=BAND", overwrite=T)
saveRDS(wind_brick_season, "../Data_Processed/wind_brick_season.rds")
...
# writeRaster(sst_season, "../Data_Processed/sst_weekly.nc",
#       overwrite=TRUE, format="CDF",
