...
SSL.AIS <- function(csvList, minlon, maxlon, minlat, maxlat, cellsize=1000, outproj=3338){
  ...
  # Save file
  st_write(AISjoined, paste0("../Data_Processed_SSLWeekly/Vector/Tracks_", MoName,".shp"))
  ...
  runtimes <- data.frame(cbind(yr, mnth, runtime_min, importtime, dftime, speedtime, linetime, jointime)) 
