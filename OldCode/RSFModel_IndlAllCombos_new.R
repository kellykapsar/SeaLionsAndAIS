...
corrs <- read.csv(paste0("./Data_Processed/Telemetry/Corrs_", ind, ".csv"))
...
for(j in 760:length(master$Var1)){
  print(paste0("Running model ", j, " of ", length(master$Var1),"."))
  ...
  output <- list(paramsums, loo1, waic1)
  fitlst <- c(fitlst, output)
}
