...
save(loolist, file=paste0("../Results/SSL_IndlAllCombos_", ind, "_loo_", datestr, ".rda"))

# Save ranks of LOO values
looranks <- loo_compare(loolist)
save(looranks, file=paste0("../Results/SSL_IndlAllCombos_", ind, "_looranks_", datestr, ".rda"))
