...
aisbound_sf <- st_read("../Data_Raw/ais_reshape.shp") %>% st_transform(prj) %>% st_crop(study)
...
# Combine the list of raster objects into a multi-layer raster (raster brick)
...
st_write(ships, "../Data_Raw/AIS_SSLWeeklySubset/Vector/EPSG32605/AllVessels_Reprojected.shp", append=F)
