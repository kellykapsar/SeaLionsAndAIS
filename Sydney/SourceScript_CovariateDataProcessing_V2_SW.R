# Title: Source Script Covariate Data Processing V2
# Author: Kelly Kapsar, Sydney Waloven
# Date: 2024-08-24
# Description: R script version of 1b_CovariateDataProcessing.Rmd for readability. Original script by Kelly Kapsar, edits made by Sydney Waloven. Source script for SSLAvailAndCovarExtraction_V2_SW.R. For plotting code, see script "Full_CovariateDataProcessing_V2_SW.R".
