...
covar_names <- c("bathymetry", "dist_land", "dist_500m", "slope", "ship", "fish", "sst", "eke", "ssh", "wind", "prox_fish_km", "prox_ships_km")
...
st_write(ssl_hr, "../Data_Processed/Telemetry/Homerange_KDE_weekly_20211020.shp")
...
# Save output points 
st_write(all_pts, "../Data_Processed/Telemetry/UsedAndAvail_WeeklyKDE_20211021.shp")
saveRDS(all_pts, "../Data_Processed/Telemetry/UsedAndAvail_WeeklyKDE_20211021.rds")

all_pts <- readRDS("../Data_Processed/Telemetry/UsedAndAvail_WeeklyKDE_20211021.rds")
...
# Save output
saveRDS(ssl4, "../Data_Processed/Telemetry/UsedAndAvail_WeeklyKDE_20211014.rds")
st_write(ssl4, "../Data_Processed/Telemetry/UsedAndAvail_WeeklyKDE_20211014.shp")
