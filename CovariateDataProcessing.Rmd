...
Weather data from [AOOS](https://gulf-of-alaska.portal.aoos.org/#search/advanced?type_group=sensor_stations&query=weather&mapBounds=-155%2C56%2C-148%2C60&time=2018-11-07T06%3A00%3A00Z%2C2020-05-03T04%3A59%3A59Z&page=1) with a spatial  and time-filtered search. Will probably have to spatially interpolate across the study area? 

Led me to [ERDDAP](http://erddap.aoos.org/erddap/tabledap/index.html?page=1&itemsPerPage=1000), which has all information from weather stations within the study area, but does not appear to include precipitation information? 
...
* Battle Creek near Homer
* Anchor River at Anchor Point
* Anchor River at New Sterling Hwy
* Seldovia

[National Buoy Data Center](https://www.ndbc.noaa.gov/) has a few buoys in the study area that have information on wave height as well as wind speed. 

[Map of buoys in study area.](https://www.ndbc.noaa.gov/obs.shtml?lat=57.550214&lon=-155.683594&zoom=5&type=oceans&status=r&pgm=&op=&ls=n) 
```{r weather data}
